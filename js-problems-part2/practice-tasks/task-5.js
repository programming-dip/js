...
function getTotalSalaryCost() {
    ...
    for (const employee of employees){
        totalSalaryCost += employee.starting+(employee.increment * employee.experience);
    }

    return totalSalaryCost;
}

console.log('The total wages cost of this organization is',getTotalSalaryCost(employees));