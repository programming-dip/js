/**
 * ou are given an array of phone objects, each containing information about the model, 
...
console.log("The average price of these phones is",findAveragePhonePrice(phones));
